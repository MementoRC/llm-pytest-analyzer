...
class TUIApp(App):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.analyzer_service = analyzer_service or PytestAnalyzerService(
    ...
    def _configure_logging(self) -> None:
        ...
        if not any(
            ...
            for h in logging.getLogger("pytest_analyzer").handlers
        ):
    ...
    def notify(self, message: str, severity: str = "information") -> None:
        ...
        # Textual's notify method for showing temporary messages
        # Note: Textual doesn't support severity, but we accept it for compatibility
