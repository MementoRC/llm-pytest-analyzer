...
from PyQt6.QtWidgets import (
    ...
    QTreeView, QTabWidget, QTextEdit, QSplitter, QFrame,
    QTableView, QHeaderView
)
from PyQt6.QtCore import Qt, QAbstractTableModel, QModelIndex, pyqtSignal, pyqtSlot
from PyQt6.QtGui import QColor, QBrush, QStandardItemModel, QStandardItem

from ..models.test_results_model import TestResultsModel, TestResult, TestGroup, TestStatus
...
class TestResultsView(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        # Connect signals
        self.results_table.selectionModel().selectionChanged.connect(self._on_test_selection_changed)
