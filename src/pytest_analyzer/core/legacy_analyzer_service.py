"""
Legacy analyzer service using the older state machine architecture.

This module is kept for backward compatibility or for specific use cases
where the older state machine is preferred.
"""
...
class StateMachinePytestAnalyzerService:
    """
    Main service for analyzing pytest test failures using a state machine architecture.

    This class leverages the analyzer state machine to coordinate the
