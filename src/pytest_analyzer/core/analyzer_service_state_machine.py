"""
Updated analyzer service using state machine architecture.

This module provides an updated implementation of the pytest analyzer service
using a state machine to manage the workflow.
"""
