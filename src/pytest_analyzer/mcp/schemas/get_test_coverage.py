...
class GetTestCoverageResponse(MCPResponse):
    ...
    def _compute_summary(self):
        ...
        self.percentage = (total_covered / total_statements * 100) if total_statements > 0 else 0.0
        ...
        self.summary = {
            ...
            "files_with_full_coverage": len([f for f in self.files if f.coverage >= 100.0]),
    ...
    def get_files_below_threshold(self, threshold: float = 80.0) -> List[CoverageFileData]:
