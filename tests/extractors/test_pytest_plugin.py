...
from src.pytest_analyzer.core.extraction.pytest_plugin import (
...
def test_collect_failures_with_plugin(mock_pytest_main):
    ...
    # Capture the result but we don't actually need to use it in this test
    _ = collect_failures_with_plugin(pytest_args)
