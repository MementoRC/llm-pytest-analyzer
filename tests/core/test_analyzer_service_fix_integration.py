...
class TestAnalyzerServiceFixIntegration:
    ...
    def test_apply_suggestion_success(self, analyzer_service, fix_suggestion, tmp_path):
        ...
        with patch.object(FixApplier, "apply_fix") as mock_apply_fix:
            ...
            assert str(source_file) in code_changes_arg, (
                "Source file path should be in code_changes"
            )
    ...
    def test_apply_suggestion_failure(self, analyzer_service, fix_suggestion, tmp_path):
        ...
        with patch.object(FixApplier, "apply_fix") as mock_apply_fix:
            ...
            assert source_file in result.rolled_back_files, (
                "Rolled back files should include source file"
            )
    ...
    def test_apply_suggestion_custom_validation_tests(
        self, analyzer_service, fix_suggestion, tmp_path
    ):
