...
from pytest_analyzer.cli.analyzer_cli import apply_suggestions_interactively, main
...
class TestCLIFixIntegration:
    ...
    def test_interactive_apply_diff(self, mock_suggestions, capsys):
        ...
        with (
            patch("pytest_analyzer.cli.analyzer_cli.show_file_diff", return_value=True),
