...
def test_about_dialog(main_window: MainWindow, qtbot: QtBot, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_settings_dialog(main_window: MainWindow, qtbot: QtBot, monkeypatch: pytest.MonkeyPatch) -> None:
